...
input_sender_value = st.text_input("Sender Value")

# @TODO:
# Add an input area where you can get a value for `receiver` from the user.
input_receiver_value = st.text_input("Receiver Value")

# @TODO:
# Add an input area where you can get a value for `amount` from the user.
input_amount_value = st.text_input("Amount")
...
if st.button("Add Block"):
    ...
    new_block = Block(
        #data=input_data,
        record = Record(sender=input_sender_value, receiver=input_receiver_value, amount=input_amount_value),
        creator_id=42,
